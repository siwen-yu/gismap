...
//定义一些常量
export var x_PI = 3.14159265358979324 * 3000.0 / 180.0;
export var PI = 3.1415926535897932384626;
export var a = 6378245.0;
export var ee = 0.00669342162296594323;
...
export function bd09towgs84(bd_lon, bd_lat) {
    let lnglat = bd09togcj02(bd_lon, bd_lat)
